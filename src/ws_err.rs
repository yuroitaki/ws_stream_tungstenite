...
impl fmt::Display for WsErr {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match &self {
            ...
            WsErr::Protocol => write!(f, "The remote committed a websocket protocol violation."),

            WsErr::ReceivedText => write!(
                f,
                "The remote sent a Text message. Only Binary messages are accepted."
            ),

            WsErr::Closed => write!(f, "The connection is already closed."),
        }
    }
}
